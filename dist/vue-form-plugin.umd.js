(function (global, factory) {
  ...
  */
  ...
  var FieldMixin = {
    ...
    methods: {
      sendValue: function sendValue(valueObj) {
        ...
        this.error = valueObj.$error; // Model service way
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c('div', {
    ...
    }, [_vm.$slots.label ? [_vm._t("label")] : _c('label', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: !_vm.hideLabel,
      ...
      staticClass: "check-label switch",
      attrs: {
        "for": _vm.randomId
      }
    })])], 2);
  ...
  var script$1 = {
    ...
    methods: {
      ...
      validate: function validate() {
        var _this$required, _this$property;

        if (((_this$required = this.required) !== null && _this$required !== void 0 ? _this$required : (_this$property = this.property) === null || _this$property === void 0 ? void 0 : _this$property.required) && !this.clonedValue.value) {
    ...
    created: function created() {
      var _ref, _this$value, _this$property2;

      this.clonedValue.value = (_ref = (_this$value = this.value) !== null && _this$value !== void 0 ? _this$value : (_this$property2 = this.property) === null || _this$property2 === void 0 ? void 0 : _this$property2.value) !== null && _ref !== void 0 ? _ref : undefined;
  ...
  var __vue_render__$1 = function __vue_render__() {
    ...
    return _c('div', [_vm.$slots.label ? [_vm._t("label")] : _c('label', {
      directives: [{
        name: "show",
        rawName: "v-show",
        value: !_vm.hideLabel,
    ...
    })], 1) : _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.displayMode === 'VIEW' && _vm.clonedValue.value && !_vm.filter ? _c('p', {
  ...
  var script$2 = {
    ...
    methods: {
      ...
      validate: function validate() {
        ...
        if (((_this$required = this.required) !== null && _this$required !== void 0 ? _this$required : (_this$property = this.property) === null || _this$property === void 0 ? void 0 : _this$property.required) && !this.clonedValue.value.length) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'required';
        } else {
          this.clonedValue.$invalid = false;
    ...
    created: function created() {
      ...
      if (this.selectFrom && this.selectFrom.length && _typeof(this.selectFrom[0]) === 'object') {
        ...
        } else if ((_this$property3 = this.property) === null || _this$property3 === void 0 ? void 0 : _this$property3.value) {
  ...
  var __vue_render__$2 = function __vue_render__() {
    ...
    })], 1) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.selectFrom && _vm.displayMode === 'VIEW' && _typeof(_vm.selectFrom[0]) === 'object' ? _c('p', {
      staticClass: "form-control-static",
      domProps: {
  ...
  var __vue_render__$3 = function __vue_render__() {
    ...
    }, 'input', _vm.attrs, false))])]) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.displayMode === 'VIEW' && _vm.clonedValue.value === undefined ? _c('p', {
      staticClass: "form-control-static"
  ...
  */
  ...
  var script$5 = {
    ...
    methods: {
      ...
      validate: function validate(val, obj) {
        var _this$required, _this$property2, _this$property3;

        if (((_this$required = this.required) !== null && _this$required !== void 0 ? _this$required : (_this$property2 = this.property) === null || _this$property2 === void 0 ? void 0 : _this$property2.required) && !this.clonedValue.value) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'required';
        } else if (!this.required && !((_this$property3 = this.property) === null || _this$property3 === void 0 ? void 0 : _this$property3.required) && !this.clonedValue.value) {
          this.clonedValue.$invalid = false;
          this.clonedValue.$error = null;
  ...
  var __vue_render__$5 = function __vue_render__() {
    ...
    })], 1) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.displayMode === 'VIEW' ? _c('p', {
      staticClass: "form-control-static"
    }, [_vm._v(_vm._s(_vm.clonedValue.value ? _vm.clonedValue.value : '-'))]) : _vm._e()], 2);
  };
  ...
  var script$6 = {
    ...
    computed: {
      items: function items() {
        var _ref, _this$selectFrom, _this$property2;

        return (_ref = (_this$selectFrom = this.selectFrom) !== null && _this$selectFrom !== void 0 ? _this$selectFrom : (_this$property2 = this.property) === null || _this$property2 === void 0 ? void 0 : _this$property2.enum) !== null && _ref !== void 0 ? _ref : [];
      },
      displayFromObject: function displayFromObject() {
        var _this = this;
    ...
    created: function created() {
      ...
      if (this.selectFrom && this.selectFrom.length && _typeof(this.selectFrom[0]) === 'object') {
        ...
        // check if any external objects exist in the list  via select from
        if (this.value) {
          if (this.fullObject) this.selected = this.selectFrom.find(function (item) {
            return item[_this3.valueField || '_id'] === _this3.value[_this3.valueField || '_id'];
          });else this.selected = this.selectFrom.find(function (item) {
            return item[_this3.valueField || '_id'] === _this3.value;
          });
        } else if ((_this$property3 = this.property) === null || _this$property3 === void 0 ? void 0 : _this$property3.value) {
          if (this.fullObject) this.selected = this.selectFrom.find(function (item) {
            return item === _this3.property.value[_this3.valueField || '_id'];
          });
        ...
        } else if ((_this$property4 = this.property) === null || _this$property4 === void 0 ? void 0 : _this$property4.value) {
  ...
  var __vue_render__$6 = function __vue_render__() {
      ...
      scopedSlots: _vm._u([{
        ...
        fn: function fn(props) {
          return [_vm.optionTemplate && _vm.optionTemplate.length > 0 && props && props.option ? _c('div', [_c('v-runtime-template', {
            ...
            staticClass: "title"
          }, [_vm._v("\n                                " + _vm._s(props.option[_vm.displayField || 'Name']) + "\n                            ")]), _vm._v(" "), props.option[_vm.descriptionField || 'Description'] ? _c('small', {
            staticClass: "text-muted"
          }, [_vm._v("\n                                " + _vm._s(props.option[_vm.descriptionField || 'Description']) + "\n                            ")]) : _vm._e()])])];
        }
      }], null, false, 419930261),
      model: {
        value: _vm.selected,
        callback: function callback($$v) {
          _vm.selected = $$v;
    ...
    })], 1)]) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.items && _vm.displayMode === 'VIEW' && typeof _vm.items[0] === 'string' && (_vm.property.filter || _vm.filter) ? _c('p', {
      staticClass: "form-control-static"
  ...
  var __vue_inject_styles__$6 = function __vue_inject_styles__(inject) {
    if (!inject) return;
    inject("data-v-3afbc9d8_0", {
      source: ".profile[data-v-3afbc9d8]{display:inline-block;margin-right:8px;border-radius:50%;height:30px;width:30px}",
      map: undefined,
      media: undefined
    });
  };
  ...
  var __vue_scope_id__$6 = "data-v-3afbc9d8";
  /* module identifier */
  ...
  var script$7 = {
    ...
    data: function data() {
      var _this$value, _this$property;

      return {
        clonedValue: {
          value: (_this$value = this.value) !== null && _this$value !== void 0 ? _this$value : (_this$property = this.property) === null || _this$property === void 0 ? void 0 : _this$property.value
        }
      };
    },
    methods: {
      ...
      validate: function validate() {
        var _this$required, _this$property2, _this$maxlength, _this$property3, _this$maxlength2, _this$property4;
        ...
        if (((_this$required = this.required) !== null && _this$required !== void 0 ? _this$required : (_this$property2 = this.property) === null || _this$property2 === void 0 ? void 0 : _this$property2.required) && !this.clonedValue.value) {
          ...
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'regex';
        } else if (((_this$maxlength = this.maxlength) !== null && _this$maxlength !== void 0 ? _this$maxlength : (_this$property3 = this.property) === null || _this$property3 === void 0 ? void 0 : _this$property3.maxlength) && this.clonedValue.value.length > ((_this$maxlength2 = this.maxlength) !== null && _this$maxlength2 !== void 0 ? _this$maxlength2 : (_this$property4 = this.property) === null || _this$property4 === void 0 ? void 0 : _this$property4.maxlength)) {
          this.clonedValue.$invalid = true;
  ...
  var __vue_render__$7 = function __vue_render__() {
    ...
    }, 'textarea', _vm.attrs, false))]) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.displayMode === 'VIEW' && (_vm.property.filter || _vm.filter) ? _c('p', {
      staticClass: "form-control-static"
  ...
  var __vue_scope_id__$7 = "data-v-78f4f5e5";
  /* module identifier */
  ...
  var script$8 = {
    ...
    methods: {
      ...
      validate: function validate() {
        var _this$required, _this$property2, _this$email, _this$property3, _this$regex, _this$property4, _this$regex2, _this$property5, _this$maxlength, _this$property6, _this$maxlength2, _this$property7;

        if (((_this$required = this.required) !== null && _this$required !== void 0 ? _this$required : (_this$property2 = this.property) === null || _this$property2 === void 0 ? void 0 : _this$property2.required) && !this.clonedValue.value) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'required'; // eslint-disable-next-line
        } else if (((_this$email = this.email) !== null && _this$email !== void 0 ? _this$email : (_this$property3 = this.property) === null || _this$property3 === void 0 ? void 0 : _this$property3.email) && !/^(([^<>()\[\].,;:\s@"]+(\.[^<>()\[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/i.test(this.clonedValue.value)) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'email';
        } else if (((_this$regex = this.regex) !== null && _this$regex !== void 0 ? _this$regex : (_this$property4 = this.property) === null || _this$property4 === void 0 ? void 0 : _this$property4.regex) && !this.clonedValue.value.test((_this$regex2 = this.regex) !== null && _this$regex2 !== void 0 ? _this$regex2 : (_this$property5 = this.property) === null || _this$property5 === void 0 ? void 0 : _this$property5.regex)) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'regex';
        } else if (((_this$maxlength = this.maxlength) !== null && _this$maxlength !== void 0 ? _this$maxlength : (_this$property6 = this.property) === null || _this$property6 === void 0 ? void 0 : _this$property6.maxlength) && (!this.clonedValue.value || this.clonedValue.value > ((_this$maxlength2 = this.maxlength) !== null && _this$maxlength2 !== void 0 ? _this$maxlength2 : (_this$property7 = this.property) === null || _this$property7 === void 0 ? void 0 : _this$property7.maxlength))) {
          this.clonedValue.$invalid = true;
          this.clonedValue.$error = 'length';
        } else {
          this.clonedValue.$invalid = false;
  ...
  var __vue_render__$8 = function __vue_render__() {
    ...
    return _c('div', [_vm.$slots.label ? [_vm._t("label")] : _c('label', {
      ...
      staticClass: "material-icons"
    }, [_vm._v("keyboard_tab")]), _vm._v(_vm._s(_vm.filteredSuggestion ? 'Press Tab to Select' : ''))]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm.$slots.view && _vm.displayMode === 'VIEW' ? [_vm._t("view")] : _vm.displayMode === 'VIEW' && _vm.property.filter || _vm.filter ? _c('p', {
      staticClass: "form-control-static"
    }, [_vm._v(_vm._s((ref = _vm.$options.filters)[_vm.filter || _vm.property.filter].apply(ref, [_vm.clonedValue.value].concat(_vm.filterArgs || _vm.property.filterArgs))))]) : _vm.displayMode === 'VIEW' ? _c('p', {
      staticClass: "form-control-static",
      domProps: {
  ...
  var __vue_render__$9 = function __vue_render__() {
    ...
    return _c('div', {
      staticClass: "form-group",
      class: [{
        'form-filled': _vm.value !== undefined && _vm.value !== '' && _vm.showValidationIndicators
      }, {
        'form-error': _vm.touched && _vm.invalid && _vm.showValidationIndicators
      }, {
        'form-success': _vm.touched && !_vm.invalid && _vm.showValidationIndicators
      }]
  ...
  var messages = {
    ...
    length: function length(props, property) {
      return 'Length of characters exceeds the allowed limit of ' + props.maxlength || property.maxlength;
    },
    required: function required(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' field is a required field';
    },
    regex: function regex(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' is not in the correct format';
    },
    min: function min(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' must be above ' + (props.min || (property && property.min !== undefined ? property.min : ''));
    },
    max: function max(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' must be below ' + (props.max || (property && property.max !== undefined ? property.max : ''));
    },
    phone: function phone(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' format is incorrect';
    },
    default: function _default(props, property) {
      return (props.label || (property && property.name ? property.name : '')) + ' is incorrect';
    }
  };
  ...
  function install$1(Vue) {
    ...
    if (options.formFor) {
      ...
      Vue.prototype.$messages = _objectSpread2({}, messages, {}, options.messages); // Merge the messages
    }
  }
  var plugin$1 = {
    install: install$1
